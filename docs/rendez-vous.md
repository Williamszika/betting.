...
3) Lance workflows/deep_research_coupon.js avec { date:"<demain>", bookmaker:"Betano", domain:"betano.de", couponTargetOdds:1.95, couponMaxOdds:3.0, oddsMin:5.0, oddsMax:7.0, maxPicks:2, maxMatches:5, prefilterFloor:0.35, hardRules:<hardRules>, softBlock:<softBlock> }. Le moteur consulte TOUS les marchés Betano et propose le MEILLEUR (pas forcément le 1X2) ; les règles hard excluent les combos interdits. Si la limite tombe, reprends (resumeFromRunId) après reset jusqu'au bout.
